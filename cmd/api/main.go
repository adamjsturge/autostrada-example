...
import (
	...
	"tester/internal/database"
	"tester/internal/smtp"
	"tester/internal/version"
...
func run(logger *slog.Logger) error {
	...
	flag.StringVar(&cfg.cookie.secretKey, "cookie-secret-key", "bagg25d3eesazncf5zz6o52i7xhacw7y", "secret key for cookie authentication/encryption")
	...
	flag.StringVar(&cfg.jwt.secretKey, "jwt-secret-key", "7brpm2wy5v7iljgslzg7yo3mzl3gnn3a", "secret key for JWT authentication")
